...
SHAP was utilized to interpret the output of our gradient boosting models. These values provide insights into the contribution of each predictor variable to the model's predictions, allowing us to identify which factors have the most significant influence on depression score. The SHAP summary plots for both the regression and classification models illustrate the impact of each predictor variable on the predicted depression scores, with color coding indicating the magnitude and direction of their influence. Both plots reveal that certain predictors, such as primarily weights, income, and sleep patterns, have a more substantial impact on depression scores compared to others, highlighting the importance of these factors in understanding depression risk. The SHAP analysis thus offers a nuanced view of how different variables contribute to the model's predictions, guiding future research and potential interventions for depression using variables that are biological and socioeconomical such as drug use, alcohol use and diseases.

#### Regression Model

![Gradient Boosting Regression Model SHAP values](images/regression_model.png){width=75%}


#####  Classificaition Model

![Gradient Boosting Classification Model SHAP vaues](images/classification_model.png){width=75%}
